...
/*
	This is where the **deployed** application is bootstrapped. It uses the angular ahead-of-time compiler. Bootstrapping is when the initial components of the application are connected
